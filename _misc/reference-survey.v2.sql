...
-- Exportiere Datenbank Struktur für d03ae584
CREATE DATABASE IF NOT EXISTS `d03ae584` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `d03ae584`;

-- Exportiere Struktur von Tabelle d03ae584.tl_survey
CREATE TABLE IF NOT EXISTS `tl_survey` (
  ...
  `surveyPage` int(10) unsigned NOT NULL DEFAULT 0,
  `reminderNotificationId` int(11) NOT NULL DEFAULT 0,
  `invitationNotificationId` int(11) NOT NULL DEFAULT 0,
  `useNotifications` char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `duration` int(10) unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

-- Exportiere Daten aus Tabelle d03ae584.tl_survey: ~1 rows (ungefähr)
DELETE FROM `tl_survey`;
INSERT INTO `tl_survey` (`id`, `resultCategories`, `tstamp`, `title`, `language`, `author`, `online_start`, `online_end`, `description`, `access`, `usecookie`, `limit_groups`, `show_title`, `show_cancel`, `allowed_groups`, `introduction`, `finalsubmission`, `allowback`, `immediate_start`, `jumpto`, `useResultCategories`, `sendConfirmationMail`, `sendConfirmationMailAlternate`, `confirmationMailAlternateCondition`, `confirmationMailRecipientField`, `confirmationMailRecipient`, `confirmationMailAlternateRecipient`, `confirmationMailSender`, `confirmationMailAlternateSender`, `confirmationMailReplyto`, `confirmationMailAlternateReplyto`, `confirmationMailSubject`, `confirmationMailAlternateSubject`, `confirmationMailText`, `confirmationMailAlternateText`, `confirmationMailTemplate`, `confirmationMailAlternateTemplate`, `sendFormattedMail`, `formattedMailRecipient`, `formattedMailSubject`, `formattedMailText`, `formattedMailTemplate`, `formattedMailSkipEmpty`, `addConfirmationMailAttachments`, `addConfirmationMailAlternateAttachments`, `confirmationMailAttachments`, `confirmationMailAlternateAttachments`, `surveyPage`, `reminderNotificationId`, `invitationNotificationId`, `useNotifications`, `duration`) VALUES
	(3, _binary , 1694517265, 'Anonymisierte Referenzumfrage', 'de', 2, '', '', 'Anonymisierte Referenzumfrage', 'anon', '', '0', '1', '1', NULL, '', '<p>Vielen Dank, dass Sie an der Umfrage teilgenommen haben.</p>', '1', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, NULL, '', NULL, '', NULL, NULL, '', '', '', NULL, NULL, 0, 0, 0, '', 0),
	(4, _binary , 1694517330, 'Anonymisierte oder personalisierte Referenzumfrage mit TANs', 'de', 2, '', '', 'Anonymisierte oder personalisierte Referenzumfrage mit TANs', 'anoncode', '', '', '1', '1', NULL, '', '<p>Vielen Dank, dass Sie an der Umfrage teilgenommen haben.</p>', '1', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, NULL, '', NULL, '', NULL, NULL, '', '', '', NULL, NULL, 0, 0, 0, '', 0),
	(5, _binary , 1694517369, 'Personalisierte Referenzumfrage', 'de', 2, '', '', 'Personalisierte Referenzumfrage', 'nonanoncode', '', '', '1', '1', NULL, '', '<p>Vielen Dank, dass Sie an der Umfrage teilgenommen haben.</p>', '1', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, NULL, '', NULL, '', NULL, NULL, '', '', '', NULL, NULL, 0, 0, 0, '', 0);

-- Exportiere Struktur von Tabelle d03ae584.tl_survey_condition
...
-- Exportiere Daten aus Tabelle d03ae584.tl_survey_condition: ~0 rows (ungefähr)
DELETE FROM `tl_survey_condition`;

-- Exportiere Struktur von Tabelle d03ae584.tl_survey_navigation
...
-- Exportiere Daten aus Tabelle d03ae584.tl_survey_navigation: ~0 rows (ungefähr)
DELETE FROM `tl_survey_navigation`;

-- Exportiere Struktur von Tabelle d03ae584.tl_survey_page
CREATE TABLE IF NOT EXISTS `tl_survey_page` (
  ...
  `markSurveyAsFinished` char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

-- Exportiere Daten aus Tabelle d03ae584.tl_survey_page: ~5 rows (ungefähr)
DELETE FROM `tl_survey_page`;
INSERT INTO `tl_survey_page` (`id`, `type`, `tstamp`, `pid`, `sorting`, `title`, `description`, `language`, `introduction`, `conditions`, `page_template`, `pagetype`, `useCustomNextButtonTitle`, `customNextButtonTitle`, `hideBackButton`, `markSurveyAsFinished`) VALUES
	...
	(10, 'default', 1694517276, 4, 128, 'Frageseite 1 - Multiple-Choice-Fragen', 'Auf dieser Seite können die drei Typen der Multiple-Choice-Fragen getestet werden', '', '<p>Im Contao-Survey gibt es drei Typen von Miltiple-Choice-Fragen.</p>\n<ol>\n<li><strong>Multiple-Choice-Frage</strong> mit <strong>Einfachauswahl</strong>. Einfachauswahl meint hier, dass man unter allen angebotenen Antworten nur eine einzige wählen kann. Wird die Option <em><strong>Andere Antwort erlauben</strong></em> aktiviert, so kann zusätzlich zu den vorgegebenen Antworten noch eine &#39;freie&#39;, also vom Proband festgelegte, Antwort gegeben werden.<br><br></li>\n<li><strong>Multiple-Choice-Frage</strong> mit <strong>Mehrfachauswahl</strong>. Mehrfachauswahl meint hier, dass man unter allen angebotenen Antworten <strong>mehrere</strong> wählen kann. Wird die Option <em><strong>Andere Antwort erlauben</strong></em> aktiviert, so kann zusätzlich zu den vorgegebenen Antworten noch eine &#39;freie&#39;, also vom Proband festgelegte, Antwort gegeben werden.<br><br></li>\n<li><strong>Multiple-Choice-Frage</strong> mit <strong>binärer/dichotomer Auswahl</strong>. Dichotom meint hier, dass man nur zwischen zwei Antworten wählen kann. In der Regel[nbsp] sind das hier Ja und Nein. Die Option <em><strong>Andere Antwort erlauben</strong></em> existiert für diesen Fragetyp nicht.</li>\n</ol>\n<p>[nbsp]</p>', '', 'survey_questionblock', 'standard', '', '', '', ''),
	(11, 'default', 1694517276, 4, 192, 'Frageseite 2 - Offene Fragen', 'Auf dieser Seite können die sechs Typen der Offenen Fragen getestet werden.', '', '<p>Im Contao-Survey gibt es sechs Typen von <strong>Offenen Fragen</strong>.</p>\n<ol>\n<li><strong>Einzeilig</strong>. </li>\n<li><strong>Mehrzeilig</strong>. </li>\n<li><strong>Ganzzahl. </strong></li>\n<li><strong>Kommazahl.<br></strong></li>\n<li><strong>Datum.<br></strong></li>\n<li><strong>Uhrzeit.<br></strong></li>\n</ol>\n<p>[nbsp]</p>', '', 'survey_questionblock', 'standard', '', '', '', ''),
	(12, 'default', 1694517276, 4, 224, 'Frageseite 3 - Matrixfragen', 'Auf dieser Seite können die zwei Typen der Matrixfragen getestet werden.', '', '<p>Im Contao-Survey gibt es zwei Typen von <strong>Matrixfragen</strong>.</p>\n<ol>\n<li><strong>Matrixfrage mit Einfachauswahl</strong>. </li>\n<li><strong>Matrixfrage mit Mehfachauswahl</strong>.</li>\n</ol>\n<p>[nbsp]</p>', '', 'survey_questionblock', 'standard', '', '', '', ''),
	(13, 'default', 1694517276, 4, 240, 'Frageseite 4 - Feste Summe', 'Auf dieser Seite kann der Fragetyp Feste Summe getestet werden.', '', '<p>Im Contao-Survey gibt es keinen Subtyp für die Frage <strong>Feste Summe</strong>!</p>', '', 'survey_questionblock', 'standard', '', '', '', ''),
	(14, 'result', 1694517276, 4, 256, 'Ergebnisseite', 'Alle Ergebnisse der Umfrage 1', '', '', '', '', 'standard', '', '', '', ''),
	(15, 'default', 1694517341, 5, 128, 'Frageseite 1 - Multiple-Choice-Fragen', 'Auf dieser Seite können die drei Typen der Multiple-Choice-Fragen getestet werden', '', '<p>Im Contao-Survey gibt es drei Typen von Miltiple-Choice-Fragen.</p>\n<ol>\n<li><strong>Multiple-Choice-Frage</strong> mit <strong>Einfachauswahl</strong>. Einfachauswahl meint hier, dass man unter allen angebotenen Antworten nur eine einzige wählen kann. Wird die Option <em><strong>Andere Antwort erlauben</strong></em> aktiviert, so kann zusätzlich zu den vorgegebenen Antworten noch eine &#39;freie&#39;, also vom Proband festgelegte, Antwort gegeben werden.<br><br></li>\n<li><strong>Multiple-Choice-Frage</strong> mit <strong>Mehrfachauswahl</strong>. Mehrfachauswahl meint hier, dass man unter allen angebotenen Antworten <strong>mehrere</strong> wählen kann. Wird die Option <em><strong>Andere Antwort erlauben</strong></em> aktiviert, so kann zusätzlich zu den vorgegebenen Antworten noch eine &#39;freie&#39;, also vom Proband festgelegte, Antwort gegeben werden.<br><br></li>\n<li><strong>Multiple-Choice-Frage</strong> mit <strong>binärer/dichotomer Auswahl</strong>. Dichotom meint hier, dass man nur zwischen zwei Antworten wählen kann. In der Regel[nbsp] sind das hier Ja und Nein. Die Option <em><strong>Andere Antwort erlauben</strong></em> existiert für diesen Fragetyp nicht.</li>\n</ol>\n<p>[nbsp]</p>', '', 'survey_questionblock', 'standard', '', '', '', ''),
	(16, 'default', 1694517341, 5, 192, 'Frageseite 2 - Offene Fragen', 'Auf dieser Seite können die sechs Typen der Offenen Fragen getestet werden.', '', '<p>Im Contao-Survey gibt es sechs Typen von <strong>Offenen Fragen</strong>.</p>\n<ol>\n<li><strong>Einzeilig</strong>. </li>\n<li><strong>Mehrzeilig</strong>. </li>\n<li><strong>Ganzzahl. </strong></li>\n<li><strong>Kommazahl.<br></strong></li>\n<li><strong>Datum.<br></strong></li>\n<li><strong>Uhrzeit.<br></strong></li>\n</ol>\n<p>[nbsp]</p>', '', 'survey_questionblock', 'standard', '', '', '', ''),
	(17, 'default', 1694517341, 5, 224, 'Frageseite 3 - Matrixfragen', 'Auf dieser Seite können die zwei Typen der Matrixfragen getestet werden.', '', '<p>Im Contao-Survey gibt es zwei Typen von <strong>Matrixfragen</strong>.</p>\n<ol>\n<li><strong>Matrixfrage mit Einfachauswahl</strong>. </li>\n<li><strong>Matrixfrage mit Mehfachauswahl</strong>.</li>\n</ol>\n<p>[nbsp]</p>', '', 'survey_questionblock', 'standard', '', '', '', ''),
	(18, 'default', 1694517341, 5, 240, 'Frageseite 4 - Feste Summe', 'Auf dieser Seite kann der Fragetyp Feste Summe getestet werden.', '', '<p>Im Contao-Survey gibt es keinen Subtyp für die Frage <strong>Feste Summe</strong>!</p>', '', 'survey_questionblock', 'standard', '', '', '', ''),
	(19, 'result', 1694517341, 5, 256, 'Ergebnisseite', 'Alle Ergebnisse der Umfrage 1', '', '', '', '', 'standard', '', '', '', '');

-- Exportiere Struktur von Tabelle d03ae584.tl_survey_participant
...
-- Exportiere Daten aus Tabelle d03ae584.tl_survey_participant: ~0 rows (ungefähr)
DELETE FROM `tl_survey_participant`;

-- Exportiere Struktur von Tabelle d03ae584.tl_survey_pin_tan
CREATE TABLE IF NOT EXISTS `tl_survey_pin_tan` (
  ...
  `tstamp` int(10) unsigned NOT NULL DEFAULT 0,
  `reminded_count` int(10) unsigned NOT NULL DEFAULT 0,
...
-- Exportiere Daten aus Tabelle d03ae584.tl_survey_pin_tan: ~0 rows (ungefähr)
DELETE FROM `tl_survey_pin_tan`;

-- Exportiere Struktur von Tabelle d03ae584.tl_survey_question
...
-- Exportiere Daten aus Tabelle d03ae584.tl_survey_question: ~12 rows (ungefähr)
...
INSERT INTO `tl_survey_question` (`id`, `tstamp`, `pid`, `sorting`, `alias`, `questiontype`, `title`, `description`, `author`, `language`, `question`, `introduction`, `obligatory`, `complete`, `original`, `help`, `hidetitle`, `lower_bound`, `upper_bound`, `lower_bound_date`, `upper_bound_date`, `lower_bound_time`, `upper_bound_time`, `openended_subtype`, `openended_textbefore`, `openended_textafter`, `openended_rows`, `openended_cols`, `openended_width`, `openended_maxlen`, `openended_textinside`, `multiplechoice_subtype`, `matrix_subtype`, `mc_style`, `choices`, `matrixrows`, `matrixcolumns`, `addneutralcolumn`, `neutralcolumn`, `addother`, `addbipolar`, `adjective1`, `adjective2`, `bipolarposition`, `othertitle`, `inputfirst`, `sumoption`, `sumchoices`, `sum`, `cssClass`) VALUES
	...
	(27, 1694517276, 10, 128, 'multiple-choice-frage-mit-einfachauswahl', 'multiplechoice', 'Multiple-Choice-Frage mit Einfachauswahl', 'Multiple-Choice-Frage mit Einfachauswahl', 1, 'de', '<p>Fragetext zur Multiple-Choice-Frage mit Einfachauswahl</p>\n<ul>\n<li><strong>nicht </strong>verpflichtend</li>\n<li>mit drei Antwortmöglichkeiten</li>\n<li>andere Antwort ist zugelassen</li>\n</ul>', '', '', '1', '1', '', '', '', '', '', '', '', '', 'oe_singleline', '', '', 5, 40, '', '', '', 'mc_singleresponse', 'matrix_singleresponse', 'vertical', _binary 0x613a333a7b693a313b613a313a7b733a363a2263686f696365223b733a393a22416e74776f72742031223b7d693a323b613a313a7b733a363a2263686f696365223b733a393a22416e74776f72742032223b7d693a333b613a313a7b733a363a2263686f696365223b733a393a22416e74776f72742033223b7d7d, NULL, NULL, '', '', '1', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(28, 1694517276, 10, 256, 'multiple-choice-frage-mit-mehrfachauswahl', 'multiplechoice', 'Multiple-Choice-Frage mit Mehrfachauswahl', 'Multiple-Choice-Frage mit Mehrfachauswahl', 1, 'de', '<p>Fragetext Multiple-Choice-Frage mit Mehrfachauswahl</p>\n<ul>\n<li>nicht verpflichtend</li>\n<li>mit drei Antwortmöglichkeiten</li>\n<li>andere Antwort ist zugelassen</li>\n</ul>', '', '', '1', '1', '', '', '', '', '', '', '', '', 'oe_singleline', '', '', 5, 40, '', '', '', 'mc_multipleresponse', 'matrix_singleresponse', 'vertical', _binary 0x613a333a7b693a313b613a313a7b733a363a2263686f696365223b733a393a22416e74776f72742031223b7d693a323b613a313a7b733a363a2263686f696365223b733a393a22416e74776f72742032223b7d693a333b613a313a7b733a363a2263686f696365223b733a393a22416e74776f72742033223b7d7d, NULL, NULL, '', '', '1', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(29, 1694517276, 10, 384, 'multiple-choice-frage-mit-zwei-antworten-ja-nein-dichotom', 'multiplechoice', 'Multiple-Choice-Frage mit zwei Antworten Ja/Nein - Dichotom', 'Multiple-Choice-Frage mit zwei Antworten Ja/Nein - DichotomMulti-Choice - Dichotom', 1, 'de', '<p>Fragetext Multiple-Choice-Frage mit zwei Antworten Ja/Nein - Dichotom</p>\n<ul>\n<li>nicht verpflichtend</li>\n</ul>', '', '', '1', '1', '', '', '', '', '', '', '', '', 'oe_singleline', '', '', 5, 40, '', '', '', 'mc_dichotomous', 'matrix_singleresponse', 'vertical', _binary 0x613a333a7b693a313b613a313a7b733a363a2263686f696365223b733a393a22416e74776f72742031223b7d693a323b613a313a7b733a363a2263686f696365223b733a393a22416e74776f72742032223b7d693a333b613a313a7b733a363a2263686f696365223b733a393a22416e74776f72742033223b7d7d, NULL, NULL, '', '', '1', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(30, 1694517276, 11, 128, 'offene-frage-einzeilig', 'openended', 'Offene Frage - Einzeilig', 'Offene Frage - Einzeilig', 1, 'de', '<p>Fragetext zur offenen Frage - Einzeilig</p>\n<ul>\n<li>nicht <strong>verpflichtend</strong></li>\n</ul>', '', '', '1', '1', '', '', '', '', '', '', '', '', 'oe_singleline', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', 'Vorbelegung', 'mc_singleresponse', 'matrix_singleresponse', 'vertical', NULL, NULL, NULL, '', '', '', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(31, 1694517276, 11, 256, 'offene-frage-mehrzeilig', 'openended', 'Offene Frage - Mehrzeilig', 'Offene Frage - Mehrzeilig', 1, 'de', '<p>Fragetext zur offenen Frage - Mehrzeilig</p>\n<ul>\n<li>nicht <strong>verpflichtend</strong></li>\n</ul>', '', '', '1', '1', '', '', '', '', '', '', '', '', 'oe_multiline', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', 'Vorbelegung', 'mc_singleresponse', 'matrix_singleresponse', 'vertical', NULL, NULL, NULL, '', '', '', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(32, 1694517276, 11, 384, 'offene-frage-ganzzahl', 'openended', 'Offene Frage - Ganzzahl', 'Offene Frage - Ganzzahl', 1, 'de', '<p>Fragetext zur offenen Frage - Ganzzahl</p>\n<ul>\n<li>nicht <strong>verpflichtend<br></strong></li>\n<li>willkürlicher Wertebereich von 0 bis 100</li>\n</ul>', '', '', '1', '1', '', '', '0', '100', '', '', '', '', 'oe_integer', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', '42', 'mc_singleresponse', 'matrix_singleresponse', 'vertical', NULL, NULL, NULL, '', '', '', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(33, 1694517276, 11, 512, 'offene-frage-kommazahl', 'openended', 'Offene Frage - Kommazahl', 'Offene Frage - Kommazahl', 1, 'de', '<p>Fragetext zur offenen Frage - Kommazahl</p>\n<ul>\n<li>nicht <strong>verpflichtend<br></strong></li>\n<li>willkürlicher Wertebereich von 0.9 bis 92.5</li>\n</ul>', '', '', '1', '1', '', '', '0.9', '92.5', '', '', '', '', 'oe_float', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', '4,2', 'mc_singleresponse', 'matrix_singleresponse', 'vertical', NULL, NULL, NULL, '', '', '', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(34, 1694517276, 11, 640, 'offene-frage-datum', 'openended', 'Offene Frage - Datum', 'Offene Frage - Datum', 1, 'de', '<p>Fragetext zur offenen Frage - Datum</p>\n<ul>\n<li>nicht <strong>verpflichtend<br></strong></li>\n<li>willkürlicher Wertebereich vom 01.01.2023 bis 31.12.2023</li>\n</ul>', '', '', '1', '1', '', '', '0.9', '92.5', '1672531200', '1703980800', '', '', 'oe_date', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', '01.05.2023', 'mc_singleresponse', 'matrix_singleresponse', 'vertical', NULL, NULL, NULL, '', '', '', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(35, 1694517276, 11, 768, 'offene-frage-uhrzeit', 'openended', 'Offene Frage - Uhrzeit', 'Offene Frage - Uhrzeit', 1, 'de', '<p>Fragetext zur offenen Frage - Uhrzeit</p>\n<ul>\n<li>nicht <strong>verpflichtend<br></strong></li>\n<li>willkürlicher Wertebereich vom 10:00 bis 12:00 Uhr</li>\n</ul>', '', '', '1', '1', '', '', '0.9', '92.5', '1672531200', '1703980800', '36000', '43200', 'oe_time', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', '11:00', 'mc_singleresponse', 'matrix_singleresponse', 'vertical', NULL, NULL, NULL, '', '', '', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(36, 1694517276, 12, 128, 'matrixfrage-einfachauswahl', 'matrix', 'Matrixfrage - Einfachauswahl', 'Matrixfrage - Einfachauswahl', 1, 'de', '<p>Fragetext zur Matrixfrage - Einfachauswahl</p>\n<ul>\n<li>nicht <strong>verpflichtend</strong></li>\n<li>willkürlich gewählte Größe von <strong>4 x 4 &#61; Zeilen x Spalten</strong></li>\n<li>neutrale Spalte ist <strong>nicht </strong>erlaubt</li>\n<li>entgegengesetzte Pole werden <strong>nicht </strong>angezeigt</li>\n</ul>', '', '', '1', '1', '', '', '', '', '', '', '', '', 'oe_singleline', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', 'Vorbelegung', 'mc_singleresponse', 'matrix_singleresponse', 'vertical', NULL, _binary 0x613a343a7b693a303b733a373a225a65696c652031223b693a313b733a373a225a65696c652032223b693a323b733a373a225a65696c652033223b693a333b733a373a225a65696c652034223b7d, _binary 0x613a343a7b693a303b733a383a225370616c74652031223b693a313b733a383a225370616c74652032223b693a323b733a383a225370616c74652033223b693a333b733a383a225370616c74652034223b7d, '', '', '', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(37, 1694517276, 12, 256, 'matrixfrage-mehrfachauswahl', 'matrix', 'Matrixfrage - Mehrfachauswahl', 'Matrixfrage - Mehrfachauswahl', 1, 'de', '<p>Fragetext zur Matrixfrage - Mehrfachauswahl</p>\n<ul>\n<li>nicht <strong>verpflichtend</strong></li>\n<li>willkürlich gewählte Größe von <strong>4 x 4 &#61; Zeilen x Spalten</strong></li>\n<li>neutrale Spalte ist <strong>nicht </strong>erlaubt</li>\n<li>entgegengesetzte Pole werden <strong>nicht </strong>angezeigt</li>\n</ul>', '', '', '1', '1', '', '', '', '', '', '', '', '', 'oe_singleline', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', 'Vorbelegung', 'mc_singleresponse', 'matrix_multipleresponse', 'vertical', NULL, _binary 0x613a343a7b693a303b733a373a225a65696c652031223b693a313b733a373a225a65696c652032223b693a323b733a373a225a65696c652033223b693a333b733a373a225a65696c652034223b7d, _binary 0x613a343a7b693a303b733a383a225370616c74652031223b693a313b733a383a225370616c74652032223b693a323b733a383a225370616c74652033223b693a333b733a383a225370616c74652034223b7d, '', '', '', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(38, 1694517276, 13, 128, 'feste-summe', 'constantsum', 'Feste Summe', 'Feste Summe', 1, 'de', '<p>Fragetext zum Fragetyp Festen Summe</p>\n<ul>\n<li>nicht <strong>verpflichtend</strong></li>\n<li>willkürlich gewählte <strong>vier </strong>Antworten</li>\n<li>Summe 100</li>\n</ul>', '', '', '1', '1', '', '', '', '', '', '', '', '', 'oe_singleline', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', 'Vorbelegung', 'mc_singleresponse', 'matrix_singleresponse', 'vertical', NULL, _binary 0x613a343a7b693a303b733a373a225a65696c652031223b693a313b733a373a225a65696c652032223b693a323b733a373a225a65696c652033223b693a333b733a373a225a65696c652034223b7d, _binary 0x613a343a7b693a303b733a383a225370616c74652031223b693a313b733a383a225370616c74652032223b693a323b733a383a225370616c74652033223b693a333b733a383a225370616c74652034223b7d, '', '', '', '', '', '', 'top', '', '', 'exact', _binary 0x613a343a7b693a303b733a31303a22416e74776f7274203235223b693a313b733a31303a22416e74776f7274203235223b693a323b733a31303a22416e74776f7274203235223b693a333b733a31303a22416e74776f7274203235223b7d, 100, ''),
	(39, 1694517341, 16, 128, 'offene-frage-einzeilig', 'openended', 'Offene Frage - Einzeilig', 'Offene Frage - Einzeilig', 1, 'de', '<p>Fragetext zur offenen Frage - Einzeilig</p>\n<ul>\n<li>nicht <strong>verpflichtend</strong></li>\n</ul>', '', '', '1', '1', '', '', '', '', '', '', '', '', 'oe_singleline', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', 'Vorbelegung', 'mc_singleresponse', 'matrix_singleresponse', 'vertical', NULL, NULL, NULL, '', '', '', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(40, 1694517341, 16, 256, 'offene-frage-mehrzeilig', 'openended', 'Offene Frage - Mehrzeilig', 'Offene Frage - Mehrzeilig', 1, 'de', '<p>Fragetext zur offenen Frage - Mehrzeilig</p>\n<ul>\n<li>nicht <strong>verpflichtend</strong></li>\n</ul>', '', '', '1', '1', '', '', '', '', '', '', '', '', 'oe_multiline', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', 'Vorbelegung', 'mc_singleresponse', 'matrix_singleresponse', 'vertical', NULL, NULL, NULL, '', '', '', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(41, 1694517341, 16, 384, 'offene-frage-ganzzahl', 'openended', 'Offene Frage - Ganzzahl', 'Offene Frage - Ganzzahl', 1, 'de', '<p>Fragetext zur offenen Frage - Ganzzahl</p>\n<ul>\n<li>nicht <strong>verpflichtend<br></strong></li>\n<li>willkürlicher Wertebereich von 0 bis 100</li>\n</ul>', '', '', '1', '1', '', '', '0', '100', '', '', '', '', 'oe_integer', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', '42', 'mc_singleresponse', 'matrix_singleresponse', 'vertical', NULL, NULL, NULL, '', '', '', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(42, 1694517341, 16, 512, 'offene-frage-kommazahl', 'openended', 'Offene Frage - Kommazahl', 'Offene Frage - Kommazahl', 1, 'de', '<p>Fragetext zur offenen Frage - Kommazahl</p>\n<ul>\n<li>nicht <strong>verpflichtend<br></strong></li>\n<li>willkürlicher Wertebereich von 0.9 bis 92.5</li>\n</ul>', '', '', '1', '1', '', '', '0.9', '92.5', '', '', '', '', 'oe_float', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', '4,2', 'mc_singleresponse', 'matrix_singleresponse', 'vertical', NULL, NULL, NULL, '', '', '', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(43, 1694517341, 16, 640, 'offene-frage-datum', 'openended', 'Offene Frage - Datum', 'Offene Frage - Datum', 1, 'de', '<p>Fragetext zur offenen Frage - Datum</p>\n<ul>\n<li>nicht <strong>verpflichtend<br></strong></li>\n<li>willkürlicher Wertebereich vom 01.01.2023 bis 31.12.2023</li>\n</ul>', '', '', '1', '1', '', '', '0.9', '92.5', '1672531200', '1703980800', '', '', 'oe_date', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', '01.05.2023', 'mc_singleresponse', 'matrix_singleresponse', 'vertical', NULL, NULL, NULL, '', '', '', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(44, 1694517341, 16, 768, 'offene-frage-uhrzeit', 'openended', 'Offene Frage - Uhrzeit', 'Offene Frage - Uhrzeit', 1, 'de', '<p>Fragetext zur offenen Frage - Uhrzeit</p>\n<ul>\n<li>nicht <strong>verpflichtend<br></strong></li>\n<li>willkürlicher Wertebereich vom 10:00 bis 12:00 Uhr</li>\n</ul>', '', '', '1', '1', '', '', '0.9', '92.5', '1672531200', '1703980800', '36000', '43200', 'oe_time', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', '11:00', 'mc_singleresponse', 'matrix_singleresponse', 'vertical', NULL, NULL, NULL, '', '', '', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(45, 1694517341, 17, 128, 'matrixfrage-einfachauswahl', 'matrix', 'Matrixfrage - Einfachauswahl', 'Matrixfrage - Einfachauswahl', 1, 'de', '<p>Fragetext zur Matrixfrage - Einfachauswahl</p>\n<ul>\n<li>nicht <strong>verpflichtend</strong></li>\n<li>willkürlich gewählte Größe von <strong>4 x 4 &#61; Zeilen x Spalten</strong></li>\n<li>neutrale Spalte ist <strong>nicht </strong>erlaubt</li>\n<li>entgegengesetzte Pole werden <strong>nicht </strong>angezeigt</li>\n</ul>', '', '', '1', '1', '', '', '', '', '', '', '', '', 'oe_singleline', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', 'Vorbelegung', 'mc_singleresponse', 'matrix_singleresponse', 'vertical', NULL, _binary 0x613a343a7b693a303b733a373a225a65696c652031223b693a313b733a373a225a65696c652032223b693a323b733a373a225a65696c652033223b693a333b733a373a225a65696c652034223b7d, _binary 0x613a343a7b693a303b733a383a225370616c74652031223b693a313b733a383a225370616c74652032223b693a323b733a383a225370616c74652033223b693a333b733a383a225370616c74652034223b7d, '', '', '', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(46, 1694517341, 17, 256, 'matrixfrage-mehrfachauswahl', 'matrix', 'Matrixfrage - Mehrfachauswahl', 'Matrixfrage - Mehrfachauswahl', 1, 'de', '<p>Fragetext zur Matrixfrage - Mehrfachauswahl</p>\n<ul>\n<li>nicht <strong>verpflichtend</strong></li>\n<li>willkürlich gewählte Größe von <strong>4 x 4 &#61; Zeilen x Spalten</strong></li>\n<li>neutrale Spalte ist <strong>nicht </strong>erlaubt</li>\n<li>entgegengesetzte Pole werden <strong>nicht </strong>angezeigt</li>\n</ul>', '', '', '1', '1', '', '', '', '', '', '', '', '', 'oe_singleline', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', 'Vorbelegung', 'mc_singleresponse', 'matrix_multipleresponse', 'vertical', NULL, _binary 0x613a343a7b693a303b733a373a225a65696c652031223b693a313b733a373a225a65696c652032223b693a323b733a373a225a65696c652033223b693a333b733a373a225a65696c652034223b7d, _binary 0x613a343a7b693a303b733a383a225370616c74652031223b693a313b733a383a225370616c74652032223b693a323b733a383a225370616c74652033223b693a333b733a383a225370616c74652034223b7d, '', '', '', '', '', '', 'top', '', '', 'exact', NULL, 100, ''),
	(47, 1694517341, 18, 128, 'feste-summe', 'constantsum', 'Feste Summe', 'Feste Summe', 1, 'de', '<p>Fragetext zum Fragetyp Festen Summe</p>\n<ul>\n<li>nicht <strong>verpflichtend</strong></li>\n<li>willkürlich gewählte <strong>vier </strong>Antworten</li>\n<li>Summe 100</li>\n</ul>', '', '', '1', '1', '', '', '', '', '', '', '', '', 'oe_singleline', 'Beschriftung vor Textfeld', 'Beschirftung nach Textfeld', 5, 40, '20', '20', 'Vorbelegung', 'mc_singleresponse', 'matrix_singleresponse', 'vertical', NULL, _binary 0x613a343a7b693a303b733a373a225a65696c652031223b693a313b733a373a225a65696c652032223b693a323b733a373a225a65696c652033223b693a333b733a373a225a65696c652034223b7d, _binary 0x613a343a7b693a303b733a383a225370616c74652031223b693a313b733a383a225370616c74652032223b693a323b733a383a225370616c74652033223b693a333b733a383a225370616c74652034223b7d, '', '', '', '', '', '', 'top', '', '', 'exact', _binary 0x613a343a7b693a303b733a31303a22416e74776f7274203235223b693a313b733a31303a22416e74776f7274203235223b693a323b733a31303a22416e74776f7274203235223b693a333b733a31303a22416e74776f7274203235223b7d, 100, '');

-- Exportiere Struktur von Tabelle d03ae584.tl_survey_result
...
-- Exportiere Daten aus Tabelle d03ae584.tl_survey_result: ~0 rows (ungefähr)
DELETE FROM `tl_survey_result`;

-- Exportiere Struktur von Tabelle d03ae584.tl_survey_scale
...
-- Exportiere Daten aus Tabelle d03ae584.tl_survey_scale: ~0 rows (ungefähr)
DELETE FROM `tl_survey_scale`;

-- Exportiere Struktur von Tabelle d03ae584.tl_survey_scale_folder
...
-- Exportiere Daten aus Tabelle d03ae584.tl_survey_scale_folder: ~0 rows (ungefähr)
