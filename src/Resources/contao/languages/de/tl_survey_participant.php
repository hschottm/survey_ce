...
$GLOBALS['TL_LANG']['tl_survey_participant']['invite_success'] = 'Es wurden %s Einladungen versandt.';
$GLOBALS['TL_LANG']['tl_survey_participant']['invite_error'] = 'Der Versand der Einladungen war nicht erfolgreich. Bitte prüfen Sie das System-Log.';
$GLOBALS['TL_LANG']['tl_survey_participant']['invite_no_invitation_available'] = 'Die in der Umfrage angegebene Einladung ist nicht vorhanden.';
