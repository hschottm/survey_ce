...
$GLOBALS['TL_LANG']['tl_survey_participant']['note_template']   = "<h1>Sie möchten für die Umfrage &raquo;%s&laquo; an alle teilnehmenden Personen eine Einladung versenden.</h1><p>%s</p><p style='color:#F47C00;'>%s</p>";
$GLOBALS['TL_LANG']['tl_survey_participant']['invite_text']     = "Alle Teilnehmenden Personen erhalten eine Einladungsmail. Sie haben dafür die Nachricht &raquo;XXX&laquo; im Notification Center festgelegt. Die Einladung enthält einen personalisierten Link, mit dem die eingeladene Person die Umfrage aufrufen kann.";
$GLOBALS['TL_LANG']['tl_survey_participant']['invite_warn']     = "Je nach Größe der Zielgruppe kann das Versenden der Einladungen einige Zeit in Anspruch nehmen. Stellen Sie auch bitte sicher, dass Sie über Ihr System Massenmails versenden dürfen, damit der Hoster nicht versehentlich Ihr Konto wegen des Verdachts von Spam sperrt.";
