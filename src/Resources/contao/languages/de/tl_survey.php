...
$GLOBALS['TL_LANG']['tl_survey']['immediate_start']['0'] = 'Umfrage sofort anzeigen';
$GLOBALS['TL_LANG']['tl_survey']['immediate_start']['1'] = 'Bitte wählen Sie, ob das Formular der Umfrage sofort angezeigt werden soll.';
$GLOBALS['TL_LANG']['tl_survey']['allow_autostart'] = ['Umfrage automatisch starten','Wenn Sie diese Funktion aktivieren, dann wird beim Aufruf der Umfrageseite durch einen Link mit TAN die Umfrage automatisch gestartet. Die TAN muss also nicht extra eingegeben und bestätigt werden.'];
