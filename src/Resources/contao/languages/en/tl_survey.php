...
$GLOBALS['TL_LANG']['tl_survey']['surveyPage'] = array('Survey page','Please choose the page that contains the survey. If a page is selected an URL to the survey containing the TAN code will be created for export.');
